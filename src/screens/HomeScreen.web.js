...
import { Button, Text, Dialog, Portal, TextInput, Paragraph } from 'react-native-paper';
        ...
        { text: '取消', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              if (onLogout) onLogout();
              setTimeout(() => Alert.alert('已注销', '账号已删除，请重新注册/登录'), 300);
            } catch (e) {
        ...
        <View style={styles.list}>
          {features.map((f) => (
            <TouchableOpacity
              ...
              style={[styles.listItem, hoveredCard === f.key && styles.listItemHover]}
